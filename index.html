    ...
    <div class="caja1">
        ...
        <main id="main" class="blur">
            ...
            <div class="centrado">
                ...
                <button onclick="cambiarScript('temporada5')">
                    <img src="./img/index/nuevo/1.jpg">
                    <label>Camiseta 5</label>
                </button>
                <button onclick="cambiarScript('temporada6')">
                    <img src="./img/index/nuevo/1.jpg">
                    <label>Camiseta 6</label>
                </button>
                <button onclick="cambiarScript('temporada7')">
                    <img src="./img/index/nuevo/1.jpg">
                    <label>Camiseta 7</label>
                </button>
            </div>
    </div>
